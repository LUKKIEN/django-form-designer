...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormDefinitionField.label_fr-fr'
        db.add_column('form_designer_formdefinitionfield', 'label_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.initial_fr-fr'
        db.add_column('form_designer_formdefinitionfield', 'initial_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.help_text_fr-fr'
        db.add_column('form_designer_formdefinitionfield', 'help_text_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.choice_values_fr-fr'
        db.add_column('form_designer_formdefinitionfield', 'choice_values_fr-fr', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.choice_labels_fr-fr'
        db.add_column('form_designer_formdefinitionfield', 'choice_labels_fr-fr', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.title_fr-fr'
        db.add_column('form_designer_formdefinition', 'title_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.mail_to_fr-fr'
        db.add_column('form_designer_formdefinition', 'mail_to_fr-fr', self.gf('form_designer.template_field.TemplateCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.mail_subject_fr-fr'
        db.add_column('form_designer_formdefinition', 'mail_subject_fr-fr', self.gf('form_designer.template_field.TemplateCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.success_message_fr-fr'
        db.add_column('form_designer_formdefinition', 'success_message_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.error_message_fr-fr'
        db.add_column('form_designer_formdefinition', 'error_message_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.submit_label_fr-fr'
        db.add_column('form_designer_formdefinition', 'submit_label_fr-fr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.message_template_fr-fr'
        db.add_column('form_designer_formdefinition', 'message_template_fr-fr', self.gf('form_designer.template_field.TemplateTextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormDefinitionField.label_fr-fr'
        db.delete_column('form_designer_formdefinitionfield', 'label_fr-fr')

        # Deleting field 'FormDefinitionField.initial_fr-fr'
        db.delete_column('form_designer_formdefinitionfield', 'initial_fr-fr')

        # Deleting field 'FormDefinitionField.help_text_fr-fr'
        db.delete_column('form_designer_formdefinitionfield', 'help_text_fr-fr')

        # Deleting field 'FormDefinitionField.choice_values_fr-fr'
        db.delete_column('form_designer_formdefinitionfield', 'choice_values_fr-fr')

        # Deleting field 'FormDefinitionField.choice_labels_fr-fr'
        db.delete_column('form_designer_formdefinitionfield', 'choice_labels_fr-fr')

        # Deleting field 'FormDefinition.title_fr-fr'
        db.delete_column('form_designer_formdefinition', 'title_fr-fr')

        # Deleting field 'FormDefinition.mail_to_fr-fr'
        db.delete_column('form_designer_formdefinition', 'mail_to_fr-fr')

        # Deleting field 'FormDefinition.mail_subject_fr-fr'
        db.delete_column('form_designer_formdefinition', 'mail_subject_fr-fr')

        # Deleting field 'FormDefinition.success_message_fr-fr'
        db.delete_column('form_designer_formdefinition', 'success_message_fr-fr')

        # Deleting field 'FormDefinition.error_message_fr-fr'
        db.delete_column('form_designer_formdefinition', 'error_message_fr-fr')

        # Deleting field 'FormDefinition.submit_label_fr-fr'
        db.delete_column('form_designer_formdefinition', 'submit_label_fr-fr')

        # Deleting field 'FormDefinition.message_template_fr-fr'
        db.delete_column('form_designer_formdefinition', 'message_template_fr-fr')
