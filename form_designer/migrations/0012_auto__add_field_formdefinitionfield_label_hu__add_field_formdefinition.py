...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinitionField.label_hu'
        db.add_column('form_designer_formdefinitionfield', 'label_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinitionField.initial_hu'
        db.add_column('form_designer_formdefinitionfield', 'initial_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinitionField.help_text_hu'
        db.add_column('form_designer_formdefinitionfield', 'help_text_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinitionField.choice_values_hu'
        db.add_column('form_designer_formdefinitionfield', 'choice_values_hu',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinitionField.choice_labels_hu'
        db.add_column('form_designer_formdefinitionfield', 'choice_labels_hu',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.title_hu'
        db.add_column('form_designer_formdefinition', 'title_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.mail_to_hu'
        db.add_column('form_designer_formdefinition', 'mail_to_hu',
                      self.gf('form_designer.template_field.TemplateCharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.mail_subject_hu'
        db.add_column('form_designer_formdefinition', 'mail_subject_hu',
                      self.gf('form_designer.template_field.TemplateCharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.success_message_hu'
        db.add_column('form_designer_formdefinition', 'success_message_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.error_message_hu'
        db.add_column('form_designer_formdefinition', 'error_message_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.submit_label_hu'
        db.add_column('form_designer_formdefinition', 'submit_label_hu',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FormDefinition.message_template_hu'
        db.add_column('form_designer_formdefinition', 'message_template_hu',
                      self.gf('form_designer.template_field.TemplateTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormDefinitionField.label_hu'
        db.delete_column('form_designer_formdefinitionfield', 'label_hu')

        # Deleting field 'FormDefinitionField.initial_hu'
        db.delete_column('form_designer_formdefinitionfield', 'initial_hu')

        # Deleting field 'FormDefinitionField.help_text_hu'
        db.delete_column('form_designer_formdefinitionfield', 'help_text_hu')

        # Deleting field 'FormDefinitionField.choice_values_hu'
        db.delete_column('form_designer_formdefinitionfield', 'choice_values_hu')

        # Deleting field 'FormDefinitionField.choice_labels_hu'
        db.delete_column('form_designer_formdefinitionfield', 'choice_labels_hu')

        # Deleting field 'FormDefinition.title_hu'
        db.delete_column('form_designer_formdefinition', 'title_hu')

        # Deleting field 'FormDefinition.mail_to_hu'
        db.delete_column('form_designer_formdefinition', 'mail_to_hu')

        # Deleting field 'FormDefinition.mail_subject_hu'
        db.delete_column('form_designer_formdefinition', 'mail_subject_hu')

        # Deleting field 'FormDefinition.success_message_hu'
        db.delete_column('form_designer_formdefinition', 'success_message_hu')

        # Deleting field 'FormDefinition.error_message_hu'
        db.delete_column('form_designer_formdefinition', 'error_message_hu')

        # Deleting field 'FormDefinition.submit_label_hu'
        db.delete_column('form_designer_formdefinition', 'submit_label_hu')

        # Deleting field 'FormDefinition.message_template_hu'
        db.delete_column('form_designer_formdefinition', 'message_template_hu')
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'error_message_hu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'mail_subject_hu': ('form_designer.template_field.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'mail_to_hu': ('form_designer.template_field.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'message_template_hu': ('form_designer.template_field.TemplateTextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'submit_label_hu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'success_message_hu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'form_designer.formdefinitionfield': {
            ...
            'choice_labels_hu': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'choice_values_hu': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'help_text_hu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'initial_hu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'label_hu': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
