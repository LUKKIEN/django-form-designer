...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormDefinitionField.label_el'
        db.add_column('form_designer_formdefinitionfield', 'label_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.initial_el'
        db.add_column('form_designer_formdefinitionfield', 'initial_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.help_text_el'
        db.add_column('form_designer_formdefinitionfield', 'help_text_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.choice_values_el'
        db.add_column('form_designer_formdefinitionfield', 'choice_values_el', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinitionField.choice_labels_el'
        db.add_column('form_designer_formdefinitionfield', 'choice_labels_el', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.title_el'
        db.add_column('form_designer_formdefinition', 'title_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.mail_to_el'
        db.add_column('form_designer_formdefinition', 'mail_to_el', self.gf('form_designer.template_field.TemplateCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.mail_subject_el'
        db.add_column('form_designer_formdefinition', 'mail_subject_el', self.gf('form_designer.template_field.TemplateCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.success_message_el'
        db.add_column('form_designer_formdefinition', 'success_message_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.error_message_el'
        db.add_column('form_designer_formdefinition', 'error_message_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.submit_label_el'
        db.add_column('form_designer_formdefinition', 'submit_label_el', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.message_template_el'
        db.add_column('form_designer_formdefinition', 'message_template_el', self.gf('form_designer.template_field.TemplateTextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormDefinitionField.label_el'
        db.delete_column('form_designer_formdefinitionfield', 'label_el')

        # Deleting field 'FormDefinitionField.initial_el'
        db.delete_column('form_designer_formdefinitionfield', 'initial_el')

        # Deleting field 'FormDefinitionField.help_text_el'
        db.delete_column('form_designer_formdefinitionfield', 'help_text_el')

        # Deleting field 'FormDefinitionField.choice_values_el'
        db.delete_column('form_designer_formdefinitionfield', 'choice_values_el')

        # Deleting field 'FormDefinitionField.choice_labels_el'
        db.delete_column('form_designer_formdefinitionfield', 'choice_labels_el')

        # Deleting field 'FormDefinition.title_el'
        db.delete_column('form_designer_formdefinition', 'title_el')

        # Deleting field 'FormDefinition.mail_to_el'
        db.delete_column('form_designer_formdefinition', 'mail_to_el')

        # Deleting field 'FormDefinition.mail_subject_el'
        db.delete_column('form_designer_formdefinition', 'mail_subject_el')

        # Deleting field 'FormDefinition.success_message_el'
        db.delete_column('form_designer_formdefinition', 'success_message_el')

        # Deleting field 'FormDefinition.error_message_el'
        db.delete_column('form_designer_formdefinition', 'error_message_el')

        # Deleting field 'FormDefinition.submit_label_el'
        db.delete_column('form_designer_formdefinition', 'submit_label_el')

        # Deleting field 'FormDefinition.message_template_el'
        db.delete_column('form_designer_formdefinition', 'message_template_el')
